...
export const watch = () => {
  ...
  gulp.watch('src/assets/img/**/*', watchOptions, gulp.parallel(copyImages, htmlDev, scssDev));
...
// Copy
export const copyImages = () => gulp.src('src/assets/img/**/*')
...
export default gulp.series(
  cleanDist,
  gulp.parallel(htmlDev, scssDev, jsDev, copyImages, copyStatic, copyFonts, copyLibs),
...
export const build = gulp.series(
  cleanDist,
  gulp.parallel(htmlBuild, scssBuild, jsBuild, copyImages, copyStatic, copyFonts, copyLibs)
);
